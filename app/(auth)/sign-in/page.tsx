    ...
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden px-4 sm:px-6">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-full border border-blush/40 bg-white/70 mb-5 shadow-[0_2px_16px_rgba(138,83,65,0.12)]">
            <svg className="w-7 h-7 text-maroon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
